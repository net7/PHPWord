...
use Net7\PhpWord\Style\AbstractStyle;
use Net7\PhpWord\Style\Font;
use Net7\PhpWord\Style\Numbering;
use Net7\PhpWord\Style\Paragraph;
use Net7\PhpWord\Style\Table;
...
class Style
{
     ...
     * @param array|\Net7\PhpWord\Style\AbstractStyle $styles
     * @return \Net7\PhpWord\Style\Paragraph
     */
     ...
     *
     * @param string $styleName
     * @param array|\Net7\PhpWord\Style\AbstractStyle $fontStyle
     * @param array|\Net7\PhpWord\Style\AbstractStyle $paragraphStyle
     * @return \Net7\PhpWord\Style\Font
     */
     ...
     *
     * @param string $styleName
     * @param array|\Net7\PhpWord\Style\AbstractStyle $styleValues
     * @return \Net7\PhpWord\Style\Numbering
     * @since 0.10.0
     */
     ...
     * @return \Net7\PhpWord\Style\Table
     */
     ...
     *
     * @param array|\Net7\PhpWord\Style\AbstractStyle $styles Paragraph style definition
     * @return \Net7\PhpWord\Style\Paragraph
     */
     ...
     * Get all styles
     *
     * @return \Net7\PhpWord\Style\AbstractStyle[]
     */
     ...
     *
     * @param string $styleName
     * @return \Net7\PhpWord\Style\AbstractStyle Paragraph|Font|Table|Numbering
     */
     ...
     *
     * @param string $name
     * @param \Net7\PhpWord\Style\AbstractStyle $style
     * @param array|\Net7\PhpWord\Style\AbstractStyle $value
     * @return \Net7\PhpWord\Style\AbstractStyle
     */
