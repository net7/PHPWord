...
use Net7\PhpWord\Writer\HTML\Element\Container;
use Net7\PhpWord\Writer\HTML\Element\TextRun as TextRunWriter;
...
class Body extends AbstractPart
{
    ...
    {
        /** @var \Net7\PhpWord\Writer\HTML $parentWriter Type hint */
