...
namespace Net7\PhpWord\Metadata;

use Net7\PhpWord\ComplexType\ProofState;
use Net7\PhpWord\ComplexType\TrackChangesView;
use Net7\PhpWord\SimpleType\Zoom;
...
class Settings
{
     ...
     * @var mixed either integer, in which case it treated as a percent, or one of Net7\PhpWord\SimpleType\Zoom
     */
    private $zoom = 100;
     ...
     *
     * @var \Net7\PhpWord\ComplexType\ProofState
     */
    private $proofState;
     ...
     *
     * @var \Net7\PhpWord\Metadata\Protection
     */
     ...
     *
     * @return \Net7\PhpWord\ComplexType\TrackChangesView
     */
