...
use Net7\PhpWord\Exception\InvalidStyleException;
use Net7\PhpWord\SimpleType\Jc;
use Net7\PhpWord\SimpleType\TextAlignment;
...
class Paragraph extends Border
{
     ...
     * Indentation
     *
     * @var \Net7\PhpWord\Style\Indentation
     */
    private $indentation;
     ...
     * Spacing
     *
     * @var \Net7\PhpWord\Style\Spacing
     */
    private $spacing;
     ...
     * Get shading
     *
     * @return \Net7\PhpWord\Style\Indentation
     */
     ...
     * Get spacing
     *
     * @return \Net7\PhpWord\Style\Spacing
     ...
     *
     * @throws \Net7\PhpWord\Exception\InvalidStyleException
     * @return self
     */
    public function setLineHeight($lineHeight)
    {
        ...
        $this->setSpacingLineRule(\Net7\PhpWord\SimpleType\LineSpacingRule::AUTO);
