...
use Net7\PhpWord\ComplexType\TblWidth as TblWidthComplexType;
use Net7\PhpWord\SimpleType\Jc;
use Net7\PhpWord\SimpleType\JcTable;
use Net7\PhpWord\SimpleType\TblWidth;

class Table extends Border
{
    /**
     * @deprecated Use \Net7\PhpWord\SimpleType\TblWidth::AUTO instead
     */
    const WIDTH_AUTO = 'auto'; // Automatically determined width
    /**
     * @deprecated Use \Net7\PhpWord\SimpleType\TblWidth::PERCENT instead
     */
    const WIDTH_PERCENT = 'pct'; // Width in fiftieths (1/50) of a percent (1% = 50 unit)
    /**
     * @deprecated Use \Net7\PhpWord\SimpleType\TblWidth::TWIP instead
     */
     ...
     * Shading
     *
     * @var \Net7\PhpWord\Style\Shading
     */
    private $shading;
     ...
     * Position
     *
     * @var \Net7\PhpWord\Style\TablePosition
     */
    private $position;
     ...
     * Get shading
     *
     * @return \Net7\PhpWord\Style\Shading
     */
     ...
     * Get position
     *
     * @return \Net7\PhpWord\Style\TablePosition
     */
