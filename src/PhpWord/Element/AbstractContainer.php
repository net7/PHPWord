 ...
 *
 * @method \Net7\PhpWord\Element\OLEObject addObject(string $source, mixed $style = null) deprecated, use addOLEObject instead
 *
 * @since 0.10.0
 */
abstract class AbstractContainer extends AbstractElement
{
     ...
     * Elements collection
     *
     * @var \Net7\PhpWord\Element\AbstractElement[]
     */
     ...
     * @param mixed $args
     * @return \Net7\PhpWord\Element\AbstractElement
     */
     ...
     *
     * @param int $index
     * @return \Net7\PhpWord\Element\AbstractElement|null
     */
     ...
     *
     * @param int|\Net7\PhpWord\Element\AbstractElement $toRemove
     */
    public function removeElement($toRemove)
    {
        ...
        } elseif ($toRemove instanceof \Net7\PhpWord\Element\AbstractElement) {
     ...
     * @param mixed $paragraphStyle
     *
     * @return \Net7\PhpWord\Element\Footnote
     *
     * @codeCoverageIgnore
     */
