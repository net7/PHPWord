...
use Net7\PhpWord\Exception\InvalidImageException;
use Net7\PhpWord\Exception\UnsupportedImageTypeException;
use Net7\PhpWord\Settings;
use Net7\PhpWord\Shared\ZipArchive;
use Net7\PhpWord\Style\Image as ImageStyle;
...
class Image extends AbstractElement
{
     ...
     * @param string $name
     *
     * @throws \Net7\PhpWord\Exception\InvalidImageException
     * @throws \Net7\PhpWord\Exception\UnsupportedImageTypeException
     */
